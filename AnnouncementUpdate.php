                            ...
                            <table class="profileStyle">
                                ...
                                if (isset($_POST['submit'], $_POST['announcement_id'])) {
                                    ...
                                    if ($result) {
                                        ...
                                        echo '<td>';
                                        echo 'Date : </br>';
                                        echo '<input type="date" class="form-control" name="date" value="' . $date . '" required>';
                                        echo '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        echo '<td>';
                                        ...
                                        echo '<td>';
                                        echo 'Announcement :';
                                        echo '<textarea class="form-control" rows="10" name="announcement" required>' . $announcement . '</textarea>';
                                        echo '</td>';
                                        echo '</tr>';
                                        echo '<tr>';
                                        echo '<td>';
